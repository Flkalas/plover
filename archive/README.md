...
Code and tooling that is **not** part of the current project stage (electrical block simulation with **hwsim**).
...
To run the archived Verilog simulator, see [verilog-sim/README.md](verilog-sim/README.md).
