...
**CPLD 핀·FSM 정본:** [cpld-system-controller.md](reference/hardware/cpld-system-controller.md) · **rev G routing:** [cpld-dual-routing.md](reference/hardware/cpld-dual-routing.md)
...
**CPLD 핀 요약** (rev G dual — 상세: [cpld-system-controller.md](reference/hardware/cpld-system-controller.md)):

| 칩 | In | Out SoC | Out G-IC / datapath |
|----|-----|---------|---------------------|
| **CPLD-CU** | `OPC[4:0]`, `FLG_Z`, `CLK` | 14 strobes → ALU/MEM/PC | G-IC 6선 → DP |
| **CPLD-DP** | `d_in[7:0]`, G-IC, `CLK` | `q_a[7:0]`, `q_b[7:0]` → ALU | — |

**G-IC:** `reg_we`, `w_sel[1:0]`, `tfr_valid`, `src[1:0]` (CU→DP).
