...
|---|---|------------------|-----|-----|-------------------|
| 4 | #4 | SN74LVC283APWR | TSSOP-16 | 2 | ADD/SUB/INC/DEC |
...
*`SN74LVC04` **3** (#7×2 + #23). `SN74LVC157` **4** (#6×2 + #13×2). `SN74LVC153` **8** (ALU).*
...
| # | ↔ | MPN | Pkg | Qty | 시스템에서 하는 일 |
|---|---|-----|-----|-----|-------------------|
| 29 | #29 | 0.1 µF 50 V X7R | **0603** | **57** | IC당 1 + CPLD **+4** + 여유 ([검산](#수량-검산)) |
