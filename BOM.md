...
|------|---------------|--------------|-----------------|
| 핵심 로직 IC (ALU~클록·595) | 18종 | **42** | 38,350 |
| 물리 인프라 | 3 | — | 10,400 |
| 전원 | 3 | — | 6,400 |
| 무결성·기타 수동 | 8 | — | 13,145 |
| **전체** | **32** | — | **~68,295** |
...
| | 74HC86 (DIP) | 2 | 360 | 720 | 2의 보수(B 반전), XOR |
| | 74HC08 (DIP) | 2 | 300 | 600 | AND, 2상 클록 데드타임 |
| | 74HC32 (DIP) | 2 | 500 | 1,000 | OR |
| **레지스터/카운터** | 74HC161 (DIP) | 4 | 400 | 1,600 | 16비트 PC, 분기 제어 |
| | 74HC574 (DIP) | 7 | 500 | 3,500 | 누산/임시 레지스터, 동기 래치 |
| **버스 중재** | 74HC157 (DIP) | 5 | 400 | 2,000 | 16비트 주소 MUX, 인터리브 스위칭 |
...
| | 74HC04 (DIP) | 1 | 400 | 400 | 2상 클록·지연선·버퍼 |
