...
| 항목 | 내용 |
|------|------|
| 주문 | 2026-07-01 · 결제·출하 동시 · **완료 2026-07-10** |
...
| 항목 | 내용 |
|------|------|
| 주문 | 2026-07-03 · 결제 동시 · 출하 2026-07-04 · **완료 2026-07-10** |
...
| 항목 | 내용 |
|------|------|
| 주문 | 2026-07-06 · 결제 동시 · 출하 2026-07-07 · **배송중** (Awaiting flight · 예상 2026-07-16) |
| 판매처 | Upmall Store |
...
| MPN | 이전 | 본 주문 | 누적 | 비고 |
|-----|------|---------|------|------|
| PLCC-44→DIP | 1 (Sinstar) | +1 (Upmall, 배송중) | **2** | BOM ✓ |
