...
**물리 디코드:** IR[4:0] → CPLD idx5 FSM; Flash `$4000` CW 인덱스 **미사용** ([microcode-spec.md](reference/hardware/microcode-spec.md) §idx5).

정본: [microcode-spec.md](reference/hardware/microcode-spec.md).
