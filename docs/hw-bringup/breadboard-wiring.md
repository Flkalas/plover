...
BEQ uses **574 FLG** (Z/C) + **08/32** glue per [microcode-spec.md](../hardware/microcode-spec.md).

---

## CPLD GPR (ATF1504AS-10JU44, PLCC-44)
...
Fit target **≤40 MC** — [cpld-system-controller.md](../hardware/cpld-system-controller.md). Reset `$FFFC`: **74HC157** address MUX. CPLD on **PLCC→DIP** adapter ([BOM.md](../../BOM.md) #15, [parts-on-hand.md](../project/parts-on-hand.md)).
...
GPR registers are **inside ATF1504** (not external 574).
