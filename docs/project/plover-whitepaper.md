...
| 항목 | 내용 |
|------|------|
| **CPU** | 8-bit TTL datapath: **alu8** (14×74HC DIP) + **ATF1504** 내부 R0–R2 |
...
설계 근거: [research/design-rationale-v1.0.md](../hardware/research/design-rationale-v1.0.md) (선택: [cpu-4axis-arch-search-report.md](../hardware/cpu-4axis-arch-search-report.md)).
...
| Opcode | 동작 |
|--------|------|
| TFR01–TFR21 | R0/R1/R2 간 directed move (6종) |
...
| S5 | `plover_cc` | Subset C 컴파일러 — [subset-c.md](../software/subset-c.md) |
| S6 | C microkernel | [os-kernel.md](../software/os-kernel.md) |
...
| 버전 라벨 | 의미 |
|-----------|------|
| **v1.0** | Normative breadboard 하드웨어 |
...
| 2026-06-24 | idx5 FSM datapath; ISA `[4:0]`; S5/S6 철학 |
