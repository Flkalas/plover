...
**Role:** **Fixed 3-register file** (R0, R1, R2) + **phase sequencer** + branch sample  
**CE tree:** 74HC138×2 + 08/32/04 — **off-chip** (unchanged)  
**Search winner:** `cpld_3fixed` + `dec_cpld_seq` — see [microcode-spec-v1.1b.md](microcode-spec-v1.1b.md)

**Prior:** [cpld-system-controller.md](../../hardware/cpld-system-controller.md) (v1.0 FSM idx5)
...
| BRANCH | 1–2 | Flash-driven; FSM idle |
...
Unchanged from v1.0 — see [cpld-system-controller.md](cpld-system-controller.md) §4.
