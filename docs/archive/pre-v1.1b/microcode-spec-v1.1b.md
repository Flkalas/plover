...
**Related (archived):** [opcode-expanded-control.md](opcode-expanded-control.md) Â· [cpld-system-controller-v1.1b.md](cpld-system-controller-v1.1b.md)
...
Physical slot: **2 bytes** @ `$4000 + 2Ã—index`. All 16 bits used ??**no `ALU_OP` nibble**.
...
`MOV` (`0x0C`) deprecated in H1/H2 ??use fixed-reg copy opcodes per [opcode-expanded-control.md](opcode-expanded-control.md) Â§4.
...
**Do not migrate** CE/mailbox into CPLD ??**138Ã—2 + glue** stays off-chip.
