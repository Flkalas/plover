...
- **`net_clk2`**: 2 MHz ([hw-bringup-b3.md](archive/bringup-legacy/hw-bringup-b3.md) B3c). B3b 수동 브링업: **푸시버튼** 1회 = 574 CP 펄스.  
...
| **SRAM** | `MEM_RD` = 1 | 74HC245 경유 ([system-architecture.md](../../hardware/system-architecture.md)) |
...
B3b 단일 ACC 실험: [hw-bringup-b3.md](archive/bringup-legacy/hw-bringup-b3.md) — GPR 4개 중 **한 개**만 써도 동일 원리.
...
| 단계 | 작업 | Pass |
|------|------|------|
| **G0** | CPLD 소각, `LOAD_*` LED 스모크 | [hw-bringup-cpld-programming.md](archive/bringup-legacy/hw-bringup-cpld-programming.md) §5 |
