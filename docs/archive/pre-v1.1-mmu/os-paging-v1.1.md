...
**Related (archived):** [discrete-mmu-spec-v1.1.md](discrete-mmu-spec-v1.1.md) · [fault-logic-v1.1.md](fault-logic-v1.1.md) · [software-roadmap.md](../../software/software-roadmap.md)
...
| Layer | Gate |
|-------|------|
| Hardware | [M2c-mmu-v1.1.md](M2c-mmu-v1.1.md) sign-off |
