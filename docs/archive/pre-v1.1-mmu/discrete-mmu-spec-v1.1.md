...
v1.1 adds an **external MMU** built from **71024S15TYG** (128 KiB async SRAM) plus discrete 74HC glue. v1.0 **IS62C256×2** remains **main execution RAM** (64 KiB). v1.0 CE decode (138×2 + glue) and **ATF1504 GPR** are unchanged.
...
```text
  CPU VA[15:0]
       ??       ?��? VA[15:12] ?�?�??71024 (A16=0 PTE read) ?�?�??PA[15:12], V, WE
       ??                     ??       ??                     ?��??�??Fault logic ?�?�??/NMI
       ??       ?��? VA[11:0] ?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�??IS62 A[11:0]
       ?��? PA[15:12] from PTE ?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�??IS62 A[15:12]
...
| **2× IS62C256AL** | Main physical RAM (64 KiB) ??same as v1.0 |
...
- Glue owns: `MMU_LUT_OE`, `MMU_LUT_WE`, `MAIN_OE`, `MAIN_WE` interlock ([fault-logic-v1.1.md](fault-logic-v1.1.md) §3).
