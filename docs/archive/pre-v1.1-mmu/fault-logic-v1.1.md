...
**Active normative:** v1.0 ??[microcode-spec.md](../../hardware/microcode-spec.md) (`/NMI` inactive)  
**Rationale:** [README.md](README.md)

**Related (archived):** [discrete-mmu-spec-v1.1.md](discrete-mmu-spec-v1.1.md) · [memory-map-v1.1.md](memory-map-v1.1.md)
...
`/OE`/`/WE` setup documented in [M2c-mmu-v1.1.md](M2c-mmu-v1.1.md).
