...
|-------|-------|
| **마일스톤** | M2c (MMU) |
| **선행** | [M2b](M2b-memory.md) sign-off — IS62×2, MAP_MODE, `mem_decode` PASS |
| **Normative** | [discrete-mmu-spec-v1.1.md](../hardware/discrete-mmu-spec-v1.1.md) · [fault-logic-v1.1.md](../hardware/fault-logic-v1.1.md) |
...
→ M3a control store (unchanged) or OS paging lab ([os-paging-v1.1.md](../software/os-paging-v1.1.md))
