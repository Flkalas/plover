...
> **Superseded:** 2026-06-24 — see [implementation-plan-v1.0.md](../../project/implementation-plan-v1.0.md) (v1.0 content).
...
**Breadboard ?�방??(canonical):** [hw-bringup/README.md](../hw-bringup/README.md)

### M1 ??B3 real hardware

- ?�방: [M1-alu.md](../hw-bringup/M1-alu.md) · [alu-opcodes-timing.md](../hardware/alu-opcodes-timing.md)
...
| Sub | ?�방 | Scope |
|-----|------|-------|
| **M2a** | [M2a-cpld-decode.md](../hw-bringup/M2a-cpld-decode.md) | CPLD ISP·?�각, `LOAD_R*`, memory CS, reset `$FFFC` |
...
- ?�방: [M5-cpu-e2e.md](../hw-bringup/M5-cpu-e2e.md)
...
| 2026-06-08 | M1?�M5 breadboard ?�방????[hw-bringup/](../hw-bringup/README.md) |
| 2026-06-08 | ?�세????M1-b3, M2b split, M3b F0?�F6, ?�업???�크?�루 |
