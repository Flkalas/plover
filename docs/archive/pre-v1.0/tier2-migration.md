...
**Decisions:** [hardware-architecture-synthesis.md](../../hardware/research/hardware-architecture-synthesis.md) §10.1
...
- **ATF16V8B GAL** — redundant with 138×2; no parasitic win ([synthesis §5.3](../../hardware/research/hardware-architecture-synthesis.md)).
