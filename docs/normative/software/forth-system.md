...
Reference interpreter and Rust port are in archived bundles (`host_toolchain.tar.gz`, `rust_vm.tar.gz`). See [archived-code-guide.md](../../developer/archived-code-guide.md).
