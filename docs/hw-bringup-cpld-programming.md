...
권장: **[ALU8 조립 완료](hw-bringup-alu8-assembly-spec.md) (B3a)** → **CPLD 소각·벤치 검증** → **[GPR–ALU 배선](hw-bringup-gpr-alu.md)** → SRAM/ROM/클록.
...
- **0.1 µF** CPLD VCC–GND **최단** (어댑터 4면 권장, [cpld-system-controller.md](cpld-system-controller.md) §7).  
...
| 단계 | 내용 |
|------|------|
| 1 | [cpld-system-controller.md](cpld-system-controller.md) 포트·방정식을 **ABEL** 또는 **VHDL** 로 구현 |
...
상세 맵: [memory-map.md](memory-map.md).
...
| RAM CS 반전 | Active-low vs 설계 의도 ([cpld-system-controller.md](cpld-system-controller.md) §4) |
