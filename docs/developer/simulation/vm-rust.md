...
**Related:** [system-architecture.md](../../normative/hardware/system-architecture.md), [mailbox-protocol.md](mailbox-protocol.md), [display-console.md](display-console.md)
