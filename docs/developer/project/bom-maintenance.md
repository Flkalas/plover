...
[BOM.md](../../../BOM.md) ALU는 **Phase B2 · 12 DIP IC** (7485 없음, CMP flags from SUB).

| 단계 | BOM 변화 | 효과 |
|------|----------|------|
| **Phase A/B1** | `157_YBP`×2, 283, B_CTRL 153 | SUB Y **~133 ns** @ max |
| **Phase B2** | **−** `08`×2, `32`×2, `86`×2, `157_OUT`×2 | **`U_ALU_153_0..7`** bit-slice (mux1 logic + mux2 B); logic **46 ns** @ max |
...
|------|------|
| 표 라인 (#1–#36, #3a+c) | 37종 |
| 74HC DIP IC | **32** (ALU **12** + CPU 12 + 버스 1 + 클록 4 + 595×3) |
| 74HC153 / 157 / 04 | **8** / **2** / **1** (ALU 153·157 + 클록 04) |
...
| **alu8_decode PLA** | M1 bench / sim only — **not** v1.0 SoC BOM |
