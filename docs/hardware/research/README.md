...
**Link policy:** Research docs may link **to** normative specs. Normative specs link **here** only via [docs/README.md](../../README.md) — not individual search reports.
...
| [classic-memory-model-comparison.md](classic-memory-model-comparison.md) | **Comparison** | Flat 64 KiB vs classic machines; boot handoff notes |
...
## Future / rejected tracks

| Track | Status |
|-------|--------|
| **H1** `op_class` + `cpld_3seq` | Optional exploration — see 4-axis report |
| **H2** `cw16_direct` + `idx8` | P1 bypass — [microcode-spec.md](../microcode-spec.md) appendix A |
