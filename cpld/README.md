...
**Restore legacy HDL:** `tar -xzf archive/cpld-rev-g-hdl.tar.gz -C cpld` (rev G / historical). Gi1 idx5 normative prose: [archive/gi1-v1.0-normative/](../archive/gi1-v1.0-normative/).
