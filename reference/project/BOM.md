...
**1세트 부품 명세** · 5 V · 74HC DIP 빵판 · **dual CPLD** + **pipe CU** (Flash `$4000` CW 미사용)  
...
| CPU · 주소 | 11 | 74HC574 | Octal D-type flip-flop, 3-state | **3** | PC/MBR/FLG (no CW latch) |
...
| CPLD · 스위치 | 14 | ATF1504AS-10JU44 | CPLD, 64 MC | **2** | **CPLD-CU** pipe + **CPLD-DP** GPR | PLCC-44 dual CPLD |
