...
**Result:** PASS — 14 FSM opcodes in idx5 LUT, **20** active idx5 slots (unique). **No TFR** comb in Gi1.
...
Opcode summary: `0x01` ADD · `0x02` LDA · `0x03` STA · `0x04` BEQ · `0x05` JMP · `0x08` LDIO · `0x09` STIO · `0x0A` HALT · `0x0D` CMP · `0x0F` STA16. **`0x10–0x1F` invalid.**
...
- [ ] Frozen table §2 matches Gi1 CU idx5 LUT
