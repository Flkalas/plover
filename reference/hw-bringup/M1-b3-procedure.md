...
2. **ALU 코어** — [`alu8.yaml`](../../hw/netlist/blocks/alu8.yaml) ref 순서:  
   283 → 04 BINV → **153 mux2** → 283 → **153 mux1** → **157_YBP** (sum vs logic → Y).  
...
타이밍 (max corner): INC **153 ns**, SUB **136 ns**, logic **46 ns**, ADD **108 ns** (2 MHz Execute 반주기 **250 ns**). [alu-opcodes-timing.md](../hardware/alu-opcodes-timing.md) v1.4.
