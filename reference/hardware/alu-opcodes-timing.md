...
### rev G dual-CPLD paths (desk, 2 MHz)

| Path | ns | Note |
|------|---:|------|
| TFR G-IC latch | **40** | [cpld-dual-timing.md](cpld-dual-timing.md) |
| Branch BEQ | **212** | 38 ns slack @ 250 ns |
| P8 operand | **168** | System Fmax 2.53 MHz |
...
| 날짜 | 내용 |
|------|------|
| 2026-07-06 | rev G dual-CPLD timing paths (TFR 40 ns, BEQ 212 ns) |
