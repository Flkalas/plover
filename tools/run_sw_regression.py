...
MILESTONES: dict[str, list[str]] = {
    ...
    "S6": [
        ...
        "tests/test_boot_handoff.py",
        "tests/test_boot_jmp_handoff.py",
        "tests/test_boot_flags.py",
        "tests/test_device_discovery.py",
        "tests/test_gpio_port.py",
        "tests/test_serial_module.py",
    ],
    "S7a": [
        "tests/test_plover_asm.py",
        "tests/test_add_imm.py",
...
SCENARIOS: dict[str, list[str]] = {
    ...
    "S6": ["hw/scenarios/vm/rom_gpio_smoke.yaml", "hw/scenarios/vm/forth_boot.yaml", "hw/scenarios/vm/os_boot.yaml"],
    "S7d": [
